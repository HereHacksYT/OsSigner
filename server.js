...
app.post('/api/sign', upload.fields([
    ...
    try {
        ...
        // 6. rcodesign ile Tam İmzalama (--profile parametresiyle)
        const signCmd = `rcodesign sign --p12-file "${finalP12Path}" --p12-password "${password}" --profile "${provPath}" "${appBundle}"`;
